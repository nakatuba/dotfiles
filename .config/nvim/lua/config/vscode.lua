...
vim.keymap.set({'n', 'x'}, '<leader>e',  function() vscode.action('workbench.view.explorer') end)
vim.keymap.set({'n', 'x'}, '<leader>f',  function() vscode.action('workbench.action.quickOpen') end)
vim.keymap.set({'n', 'x'}, '<leader>g',  function() vscode.action('workbench.action.findInFiles') end)
vim.keymap.set({'n', 'x'}, '<leader>b',  function() vscode.action('workbench.action.showAllEditors') end)
vim.keymap.set({'n', 'x'}, 'ghs',        function() vscode.action('git.stageSelectedRanges') end)
vim.keymap.set({'n', 'x'}, 'ghr',        function() vscode.action('git.revertSelectedRanges') end)
vim.keymap.set({'n', 'x'}, 'ghu',        function() vscode.action('git.unstageSelectedRanges') end)
