...
vim.keymap.set('n', '<Leader>s',  function() require('vscode').call('workbench.action.gotoSymbol') end)
vim.keymap.set('n', '<Leader>d',  function() require('vscode').call('workbench.actions.view.problems') end)
vim.keymap.set('n', '[d',         function() require('vscode').call('editor.action.marker.prev') end)
vim.keymap.set('n', ']d',         function() require('vscode').call('editor.action.marker.next') end)
